...
const Navbar = () => {
  ...
  const handleSidebar = () => {
    return SetIsOpen(!isOpen), SetSiginUp(false), SetVisibleError(false);
  };
  const handleSignIn = () => {
    return SetSiginUp(!isSiginUp);
  };
    ...
    <header>
      <nav className="flex-container">
        <div className="nav-item1">
          <span className="nav-span">
            {" "}
            <img className="nav-img" src={title} alt="unipick" />
          </span>
        ...
        <div className="nav-item2">
          <ul>
            <li className="nav-left">
              <img className="nav-img" src={cart} alt="cart"></img>cart
            </li>
            <li className="nav-left">
              <img className="nav-img" src={gi} alt="location"></img>GI
            </li>
            <li className="nav-left">
              <img className="nav-img" src={collection} alt="collection"></img>
              Collection
            </li>
            <li className="nav-left">
              <img className="nav-img" src={social} alt="Social"></img>social
            </li>
      ...
      <div className="diff-pages">
        <div className="diff-pages-items">
          <p>
            {" "}
            <Link to="/explore-all" className="paths">
              Explore All
            </Link>
          </p>
          <p>Wellness</p>
